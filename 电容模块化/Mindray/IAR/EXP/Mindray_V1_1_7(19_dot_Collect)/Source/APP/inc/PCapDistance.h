...
* @param[in]   	altitude : 传感器的9段高度; 	uint16_t altitude[9]={5,15,30,50,70,90,105,115,122};            //以122mm迈瑞电容传感器为例
* @return       函数执行结果
* - 1(成功)
* - 0(失败)
* @note  \n
...
/**@brief       标定的参数初始，不使用三点标定
* @param[in]    *SegmentValue : 数数组方式传入19个点的电容值;uint32_t SegmentValue[19]={xxxx,xxxx};
* @param[in]   	altitude : 传感器的9段高度; 	uint16_t altitude[9]={5,15,30,50,70,90,105,115,122};
* @return       函数执行结果
* - 1(成功)
* - 0(失败)
* @note  \n

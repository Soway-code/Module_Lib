...
extern uint32_t PCap_buf[2];
extern uint32_t altit;
...
void MBASCII_Fun04(void)
{
    ...
    for(long k = 0; k < RegisterNum; ReadAdrL += 2, k += 2)
    {
        ...
        case 0x08:
            Data_Buf = (uint32_t)PCap_buf[1];                            //当前电容值              
            break;

        case 0x0A:
            Data_Buf = (uint32_t)HexToUlong(&Cur_Param[CAPLOW1]);               //介质1零点电容            
            break;            
        ...
        case 0x0E:
            Data_Buf = (uint32_t)HexToUlong(&Cur_Param[CAPLOW2]);           //介质2零点电容     
            break; 
        ...
        case 0x12:
            Data_Buf = (uint32_t)HexToUlong(&Cur_Param[CAPLOW3]);           //介质3零点电容     
            break; 
        ...
        case 0x16:
            Data_Buf = (uint32_t)HexToUlong(&Cur_Param[CAPLOW4]);           //介质4零点电容     
            break; 
        ...
        case 0x1A:
            Data_Buf = (uint32_t)HexToUlong(&Cur_Param[CAPLOW5]);           //介质5零点电容     
            break; 
        ...
        case 0x1E:
            ...
            Data_Buf =(uint32_t)HexToUlong(&Cur_Param[CAPMIN1+AddrOffset]);      //空电容              
            break;            
...
void MBASCII_Fun05(void)
{
    ...
    static uint32_t Cur_Param_buf[19];
    static uint8_t CalibFlag1 = 0;
...
*/
    ...
    {   
        case 0x50:
            ...
            if((RcvBuf[4] == 0x00) && (RcvBuf[5] == 0x00) &&  (CalibFlag1 == 0))                      //三点校准标定液位1 （122mm）
            {
                Cur_Param_buf[0] =PCap_buf[1];
                CalibFlag1 = 1;
            }
            else if((RcvBuf[4] == 0x01) && (RcvBuf[5] == 0x00) &&  (CalibFlag1 == 1))                      //三点校准标定液位2 （0mm）
            {
                Cur_Param_buf[1] =PCap_buf[1];
                CalibFlag1 = 2;
            }
            else if((RcvBuf[4] == 0x02) && (RcvBuf[5] == 0x00) &&  (CalibFlag1 == 2))                      //三点校准标定液位3 （传感器离开水面后回到0mm）
            {
                Cur_Param_buf[2] =PCap_buf[1];
                CalibFlag1 = 3;
            }
            
            else if((RcvBuf[4] == 0x0A) && (RcvBuf[5] == 0x00) &&  (RunVarParam.CalibFlag == 0))                      //标定液位1
            {
                Cur_Param_buf[0] =PCap_buf[1];
                RunVarParam.CalibFlag = 1;
            }
            else if((RcvBuf[4] == 0x0B) && (RcvBuf[5] == 0x00) && (RunVarParam.CalibFlag == 1))                 //标定液位2
            {
                Cur_Param_buf[1] =PCap_buf[1];
                RunVarParam.CalibFlag = 2;
            }
             else if((RcvBuf[4] == 0x0C) && (RcvBuf[5] == 0x00) && (RunVarParam.CalibFlag == 2))                 //标定液位3
            {
                Cur_Param_buf[2] =PCap_buf[1];
               RunVarParam.CalibFlag = 3;
            }
             else if((RcvBuf[4] == 0x0D) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 3))                 //标定液位4
            {
                Cur_Param_buf[3] =PCap_buf[1];
                 RunVarParam.CalibFlag = 4;
            }
             else if((RcvBuf[4] == 0x0E) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 4))                 //标定液位5
            {
                Cur_Param_buf[4] =PCap_buf[1];
                RunVarParam.CalibFlag = 5;
            }
            else if((RcvBuf[4] == 0x0F) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 5))                 //标定液位6
            {
                Cur_Param_buf[5] =PCap_buf[1];
                RunVarParam.CalibFlag = 6;
            }
            else if((RcvBuf[4] == 0x10) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 6))                 //标定液位7
            {
                Cur_Param_buf[6] =PCap_buf[1];
                 RunVarParam.CalibFlag = 7;
            }
            else if((RcvBuf[4] == 0x11) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag ==7))                 //标定液位8
            {
                Cur_Param_buf[7] =PCap_buf[1];
                 RunVarParam.CalibFlag = 8;
            }
            else if((RcvBuf[4] == 0x12) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 8))                 //标定液位9
            {
                Cur_Param_buf[8] =PCap_buf[1];
                 RunVarParam.CalibFlag = 9;
            }
            else if((RcvBuf[4] == 0x13) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 9))                 //标定液位10
            {
                Cur_Param_buf[9] =PCap_buf[1];
                RunVarParam.CalibFlag = 10;
            }
            else if((RcvBuf[4] == 0x14) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 10))                 //标定液位11
            {
                Cur_Param_buf[10] =PCap_buf[1];
                RunVarParam.CalibFlag = 11;
            }
            else if((RcvBuf[4] == 0x15) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 11))                 //标定液位12
            {
                Cur_Param_buf[11] =PCap_buf[1];
                RunVarParam.CalibFlag = 12;
            }
            else if((RcvBuf[4] == 0x16) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 12))                 //标定液位13
            {
                Cur_Param_buf[12] =PCap_buf[1];
                RunVarParam.CalibFlag = 13;
            }
            else if((RcvBuf[4] == 0x17) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 13))                 //标定液位14
            {
                Cur_Param_buf[13] =PCap_buf[1];
                RunVarParam.CalibFlag = 14;
            }
            else if((RcvBuf[4] == 0x18) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 14))                 //标定液位15
            {
                Cur_Param_buf[14] =PCap_buf[1];
                RunVarParam.CalibFlag = 15;
            }
            else if((RcvBuf[4] == 0x19) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 15))                 //标定液位16
            {
                Cur_Param_buf[15] =PCap_buf[1];
                RunVarParam.CalibFlag = 16;
            }
            else if((RcvBuf[4] == 0x1A) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 16))                 //标定液位17
            {
                Cur_Param_buf[16] =PCap_buf[1];
                RunVarParam.CalibFlag = 17;
            }
            else if((RcvBuf[4] == 0x1B) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 17))                 //标定液位18
            {
                Cur_Param_buf[17] =PCap_buf[1];
                RunVarParam.CalibFlag = 18;
            }  
            else if((RcvBuf[4] == 0x1C) && (RcvBuf[5] == 0x00)&& (RunVarParam.CalibFlag == 18))                 //标定液位19
            {
                Cur_Param_buf[18] =PCap_buf[1];
                RunVarParam.CalibFlag = 19;
            } 
            else
            { 
            ...
            if(CalibFlag1 == 3)
            {
               CalibFlag1 = 0;
               AddrOffset = (UserParam.LiquidType - 1) * 12;                //地址随液体类型偏移
              if((Cur_Param_buf[0] > Cur_Param_buf[1]) && (Cur_Param_buf[0] > Cur_Param_buf[2]) && (Cur_Param_buf[1] > Cur_Param_buf[2]))
              {              
                  for(i = 0; i < 4; i ++)
                  {
                    Cur_Param[CAPMAX1 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[0]>> (3 - i) * 8);               //满量程电容
                    Cur_Param[CAPLOW1 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[1]>> (3 - i) * 8);               //满量程到零点电容   
                    Cur_Param[CAPMIN1 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[2]>> (3 - i) * 8);             //  -0 离开水面到零点电容
                  
                  }                
                  ProductParam.EepromWrEn=0x0F;
                  Eeprom_Write3T_MultiBytes(CAPMIN1 + AddrOffset, (uint8_t const *)&Cur_Param[CAPMIN1 + AddrOffset], 4);                 //  -0 离开水面到零点电容
                  Eeprom_Write3T_MultiBytes(CAPMAX1 + AddrOffset, (uint8_t const *)&Cur_Param[CAPMAX1 + AddrOffset], 4);                 //满量程电容
                  Eeprom_Write3T_MultiBytes(CAPLOW1 + AddrOffset, (uint8_t const *)&Cur_Param[CAPLOW1 + AddrOffset], 4);                //满量程到零点电容      
                  ProductParam.EepromWrEn=0x00;
                  ArgumentInitialization();                      //计算液位高度的参数重新初始化                    
              }
              else
              {
                    MBASCII_SendErr(MB_EX_CALIBRATION_ERR);
            ...
            if(RunVarParam.CalibFlag == 19)                      //高低液位值都得到了
            {
              if((Cur_Param_buf[0] < Cur_Param_buf[9]) && (Cur_Param_buf[18] < Cur_Param_buf[9]))
              {                    
                AddrOffset = 0;             
                  for(i = 0; i < 4; i ++)
                    {                                                           //放入缓存
                        Cur_Param[CAP1_0 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[0]>> (3 - i) * 8);
                        Cur_Param[CAP1_1 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[1]>> (3 - i) * 8);
                        Cur_Param[CAP1_2 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[2]>> (3 - i) * 8);
                        Cur_Param[CAP1_3 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[3]>> (3 - i) * 8);
                        Cur_Param[CAP1_4 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[4]>> (3 - i) * 8);
                        Cur_Param[CAP1_5 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[5]>> (3 - i) * 8);
                        Cur_Param[CAP1_6 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[6]>> (3 - i) * 8);
                        Cur_Param[CAP1_7 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[7]>> (3 - i) * 8);
                        Cur_Param[CAP1_8 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[8]>> (3 - i) * 8);
                        Cur_Param[CAP1_9 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[9]>> (3 - i) * 8);
                        Cur_Param[CAP1_10 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[10]>> (3 - i) * 8);
                        Cur_Param[CAP1_11 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[11]>> (3 - i) * 8);
                        Cur_Param[CAP1_12 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[12]>> (3 - i) * 8);
                        Cur_Param[CAP1_13 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[13]>> (3 - i) * 8); 
                        Cur_Param[CAP1_14 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[14]>> (3 - i) * 8);
                        Cur_Param[CAP1_15 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[15]>> (3 - i) * 8);
                        Cur_Param[CAP1_16 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[16]>> (3 - i) * 8);
                        Cur_Param[CAP1_17 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[17]>> (3 - i) * 8);
                        Cur_Param[CAP1_18 + AddrOffset + i] = (uint8_t)(Cur_Param_buf[18]>> (3 - i) * 8);                      
                        
                    }              //写进EEPROM，获得电容量程
                   
                    ProductParam.EepromWrEn=0x0F;
                    Eeprom_Write3T_MultiBytes(CAP1_0 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_0 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_1 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_1 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_2 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_2 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_3 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_3 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_4 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_4 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_5 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_5 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_6 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_6 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_7 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_7 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_8 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_8 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_9 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_9 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_10 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_10 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_11 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_11 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_12 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_12 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_13 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_13 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_14 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_14 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_15 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_15 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_16 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_16 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_17 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_17 + AddrOffset], 4);
                    Eeprom_Write3T_MultiBytes(CAP1_18 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_18 + AddrOffset], 4);
                    
                    UserParam.LiquidType = Eeprom_Read_OneByte(LIQUIDTYPE);
                    if((UserParam.LiquidType==0) ||  UserParam.LiquidType > 5)
                         UserParam.LiquidType = 0x04;
                    AddrOffset = (UserParam.LiquidType - 1) * 12;                //地址随液体类型偏移
                    Eeprom_Write3T_MultiBytes(CAPMIN1 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_0], 4);                 //  -0 离开水面到零点电容
                    Eeprom_Write3T_MultiBytes(CAPMAX1 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_9], 4);                 //满量程电容
                    Eeprom_Write3T_MultiBytes(CAPLOW1 + AddrOffset, (uint8_t const *)&Cur_Param[CAP1_18], 4);                //满量程到零点电容    
                    
                    Cur_Param_buf[0] = 50;
                    Cur_Param_buf[1] = 10;
                    for(i = 0; i < 4; i ++)
                    {                                                           //放入缓存
                        Cur_Param[ULRIPLEUP + i] = (uint8_t)(Cur_Param_buf[0]>> (3 - i) * 8);
                        Cur_Param[ULRIPLEDE + i] = (uint8_t)(Cur_Param_buf[1]>> (3 - i) * 8);
                    }
                   Eeprom_Write3T_MultiBytes(ULRIPLEDE, (uint8_t const *)&Cur_Param[ULRIPLEDE], 4);  
                   Eeprom_Write3T_MultiBytes(ULRIPLEUP, (uint8_t const *)&Cur_Param[ULRIPLEUP], 4);  
                   
                    Eeprom_Write3T_MultiBytes(LIQUIDTYPE, &UserParam.LiquidType, 4);
                    ProductParam.EepromWrEn=0x00;
                 
                    ProductParam.CapRange = Cur_Param_buf[9] - Cur_Param_buf[0];
                    RunVarParam.CalibFlag = 0;
                    ArgumentInitialization();           //计算液位高度的参数重新初始化
                }
       ...
       case 0x55:
            if(RcvBuf[4] == 0x00) 
            {
                  if((RcvBuf[5] <= 200) && (RcvBuf[5] >=1))
                   for(i = 0; i < 4; i ++)
                    {                                                           //放入缓存
                        Cur_Param[ULRIPLEUP + i] = (uint8_t)(RcvBuf[5]>> (3 - i) * 8);
                    }
                   Eeprom_Write3T_MultiBytes(ULRIPLEUP, (uint8_t const *)&Cur_Param[ULRIPLEUP], 4);   
            }
            else if(RcvBuf[4] == 0x01) 
            {
                  if((RcvBuf[5] <= 200) && (RcvBuf[5] >=1))
                   for(i = 0; i < 4; i ++)
                    {                                                           //放入缓存
                        Cur_Param[ULRIPLEDE + i] = (uint8_t)(RcvBuf[5]>> (3 - i) * 8);
                    }
                   Eeprom_Write3T_MultiBytes(ULRIPLEDE, (uint8_t const *)&Cur_Param[ULRIPLEDE], 4);   
            }
            else if(RcvBuf[4] == 0x02) 
            {
                  if((RcvBuf[5] <= 3) && (RcvBuf[5] >=1))
                   for(i = 0; i < 4; i ++)
                    {                                                           //放入缓存
                        Cur_Param[FILTERING + i] = (uint8_t)(RcvBuf[5]>> (3 - i) * 8);
                    }
                   Eeprom_Write3T_MultiBytes(FILTERING, (uint8_t const *)&Cur_Param[FILTERING], 4);   
            }
            else if(RcvBuf[4] == 0x03) 
            {
                   for(i = 0; i < 4; i ++)
                    {                                                           //放入缓存
                        Cur_Param[OPTIMIZ + i] = (uint8_t)(RcvBuf[5]>> (3 - i) * 8);
                    }
                   Eeprom_Write3T_MultiBytes(OPTIMIZ, (uint8_t const *)&Cur_Param[OPTIMIZ], 4);   
            }
...
void ModbusAutoUpload(void)
{
    ...
    DataBuf = (uint32_t)PCap_buf[1];                                               //原始电容值
    for(i = 4; i > 0; i--)
    {
        SenBuf[SenBufLen++] = (uint8_t)(DataBuf >> ((i - 1) * 8));
    }    

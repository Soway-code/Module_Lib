...
{ 
	switch (pch->PortNbr) 
	{ 
		case 1 : USART_ITConfig(USART1, USART_IT_TC, ENABLE); break;	//传输完成中断
...
{ 
	switch (pch->PortNbr) 
	{ 
		case 1 : USART_ITConfig(USART1, USART_IT_RXNE, ENABLE); break;	//接收数据寄存器不是空中断
...
{ 
	switch (pch->PortNbr) 
	{ 
		case 1 : USART_ITConfig(USART1, USART_IT_TC, DISABLE); break;	//传输完成中断
...
{ 
	switch (pch->PortNbr) 
	{ 
		case 1 : USART_ITConfig(USART1, USART_IT_RXNE, DISABLE); break;	//接收数据寄存器不是空中断
